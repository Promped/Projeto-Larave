                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                        <div class="flex flex-col">
                            ...
                            {{-- Barra de progresso visual para o TCC --}}
                            <div class="w-full bg-gray-200 rounded-full h-1.5 mt-2">
                                <div class="bg-blue-500 h-1.5 rounded-full" style="width: {{ min(($insumo->quantidade_atual / $insumo->limite_maximo) * 100, 100) }}%"></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-5 py-5 border-b border-gray-200 text-sm">
                        @if($insumo->quantidade_atual <= $insumo->quantidade_minima)
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold bg-red-100 text-red-700 animate-pulse">
                                <span class="mr-1">🚨</span> CRÍTICO: REPOR (F_S04)
                            </span>
