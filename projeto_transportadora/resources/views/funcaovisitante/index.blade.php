            ...
            <table class="min-w-full table-auto">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-8 py-6 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Nome</th>
                        ...
                        <th class="px-8 py-6 text-right text-xs font-medium text-gray-500 uppercase tracking-wider"></th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-8 py-6 whitespace-nowrap text-sm text-gray-900">{{ $item->nome }}</td>
